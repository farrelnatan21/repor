...
$from=$_POST['from'];
$end=$_POST['end'];
$get=mysqli_query($koneksi,"SELECT * FROM konten where tanggal BETWEEN '$from' AND '$end' and topik='Morfologi Scanning Kaki'");
$mpdf = new \Mpdf\Mpdf();
$html = '<!DOCTYPE html>
<html>
<head>
...
$mpdf->WriteHTML($html);
$mpdf->Output('cetakmorfologi.pdf', \Mpdf\Output\Destination::INLINE);
?>