...
$from=$_POST['from'];
$end=$_POST['end'];
$get=mysqli_query($koneksi,"SELECT * FROM konten where tanggal BETWEEN '$from' AND '$end' and topik='Tangan Mekanik metakarpal'");
$mpdf = new \Mpdf\Mpdf();
$html = '<!DOCTYPE html>
<html>
<head>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Tangan-Mekanik-metakarpal.pdf', \Mpdf\Output\Destination::INLINE);
?>