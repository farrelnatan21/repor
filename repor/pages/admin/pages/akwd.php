<section id="main-content">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="?p=akwd">Above Knee with Damper</a>
    ...
    <a class="dropdown-item" href="?p=apatit">Hydroxy Apatit</a>
  </div>
</div>
          <!-- /col-md-12 -->
        </div>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <form action="cetakakwd.php" method="post">
                  <!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  Launch demo modal
</button>
<form action="pages/cetakapatit.php" method="post">
<!-- Modal -->
    ...
    <div class="form-group">
      ...
      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button class="btn btn-primary" type="submit" name="submit" value="proses" onclick="return valid();">Print</button>
            ...
            $no = 0;
            $data=$koneksi->query("SELECT * FROM konten where topik='Above Knee With Damper'");
