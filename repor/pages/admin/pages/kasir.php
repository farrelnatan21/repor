    ...
    <div class="row mt">
      <div class="col-md-12">
        <div class="content-panel">
          <table class="table table-advance table-hover table-responsive">
            ...
            while($m=mysqli_fetch_array($data)){
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary" href="../../pages/admin/pages/uptksr_sdh.php?id=<?php echo $m['id']; ?>">sudah transfer</a>
                    <a class="btn btn-warning" href="../../pages/admin/pages/uptksr_blm.php?id=<?php echo $m['id']; ?>">belum transfer</a>
                  </td>
                </tr>
                <?php
              }
