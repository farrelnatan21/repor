          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i><a href="pages/pdfmorfologi.php" target="_blank"> CETAK</h4></a>
                <hr>
                <thead>
                  <tr>
            ...
            $data=$koneksi->query("SELECT * FROM konten where topik='Tangan Mekanik Metakarpal' and tanggal between '$startdate' and 
            '$enddate'");
